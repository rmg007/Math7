...
export const BulkImportProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const processImport = async () => {
    ...
    try {
      const markName = 'BulkImport:process';
      ...
      captureException(err as Error, {
        tags: { component: 'BulkImportProvider', method: 'processImport' },
  ...
  const addToQueue = (questions: QueuedQuestion[]) => {
    setImportQueue((prev) => [...prev, ...questions]);
  };
