  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8 animate-in fade-in duration-500 pb-20">
      ...
      <form
        ...
        className="space-y-8 bg-white border border-slate-200 rounded-2xl p-8 shadow-xl"
      >
        <div className="space-y-6">
          <div className="space-y-3">
            <Label htmlFor="name" className="text-slate-900 text-base">
              Group Name
            </Label>
            <Input
              id="name"
            ...
            >
              <Label
                ...
                className={cn(
                  ...
                  type === 'class'
                    ? 'border-blue-500 bg-blue-50 shadow-[0_0_20px_rgba(59,130,246,0.1)]'
                    : 'border-slate-200 bg-white opacity-60 hover:opacity-100'
                )}
              >
                <RadioGroupItem value="class" id="class" className="sr-only" />
                <School
                  className={cn('h-10 w-10', type === 'class' ? 'text-blue-500' : 'text-slate-400')}
                />
              ...
              <Label
                ...
                className={cn(
                  'flex flex-col items-center justify-between rounded-xl border-2 p-6 hover:bg-slate-50 cursor-pointer transition-all gap-4',
                  type === 'family'
                    ? 'border-purple-500 bg-purple-50 shadow-[0_0_20px_rgba(168,85,247,0.1)]'
                    : 'border-slate-200 bg-white opacity-60 hover:opacity-100'
                )}
              >
                ...
                <Home
                  className={cn(
                    'h-10 w-10',
                    type === 'family' ? 'text-purple-500' : 'text-slate-400'
                  )}
                />
                <div className="text-center">
          ...
          <div className="flex items-center justify-between rounded-xl border border-slate-200 p-5 bg-slate-50">
            <div className="space-y-1">
              ...
              <p className="text-sm text-slate-600 max-w-[300px]">
                If enabled, students can join your group simply by entering the Join Code, without
        ...
        <Button
          ...
          size="lg"
          className="w-full bg-gradient-to-r from-purple-500 to-blue-600 hover:from-purple-400 hover:to-blue-500 text-lg font-semibold shadow-lg shadow-purple-500/25 border-0"
        >
