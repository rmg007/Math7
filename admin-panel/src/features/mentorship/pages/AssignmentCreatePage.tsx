      ...
      <div className="bg-white/70 backdrop-blur-xl rounded-[2.5rem] border border-white/20 p-10 shadow-sm hover:shadow-xl transition-all duration-500 space-y-12">
        <div className="space-y-6">
          <div className="flex items-center gap-3">
            ...
            <label className="text-2xs font-black text-gray-400 uppercase tracking-extra-wide italic">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              <div
                className={cn(
                  'p-2.5 w-fit rounded-xl mb-4 transition-transform group-hover:scale-110',
                  type === 'skill_mastery'
              ...
              <div className="font-black text-gray-900 uppercase italic tracking-tight text-sm">
                Skill Mastery
              </div>
              <div className="text-2xs font-bold text-gray-400 uppercase tracking-widest mt-1">
                Complete objectives
              </div>
            </button>
            ...
            >
              <div
                className={cn(
                  'p-2.5 w-fit rounded-xl mb-4 transition-transform group-hover:scale-110',
                  type === 'time_goal' ? 'bg-purple-600 text-white' : 'bg-purple-50 text-purple-600'
                )}
              >
            ...
            >
              ...
              <div className="font-black text-gray-400 uppercase italic tracking-tight text-sm">
                Custom Task
              </div>
              <div className="text-2xs font-bold text-gray-400 uppercase tracking-widest mt-1">
                Under development
            ...
            <div className="space-y-4">
              ...
              <div className="max-h-80 overflow-y-auto border border-gray-100 rounded-[1.5rem] divide-y divide-gray-50 bg-white/30 backdrop-blur-sm custom-scrollbar">
                {skills?.map((skill: Skill) => (
                  ...
                  >
                    <div>
                      <div className="font-black text-gray-900 text-base italic tracking-tight">
                        {skill.title}
                      </div>
            ...
            <div className="flex bg-gray-100/50 backdrop-blur-sm border border-gray-100 p-1.5 rounded-2xl">
              {(['mandatory', 'suggested'] as const).map((s) => (
                <button
                  ...
                  onClick={() => setScope(s)}
                  className={cn(
                    'flex-1 py-3 text-2xs font-black uppercase tracking-widest rounded-xl transition-all duration-300',
                    scope === s
        ...
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-6 border-t border-gray-100/50">
          <div className="flex items-center gap-3 px-6 py-3 bg-gray-50/50 rounded-2xl border border-gray-100">
            <div
              className={cn(
                ...
                targetId ? 'bg-emerald-500 animate-pulse' : 'bg-gray-300'
              )}
            ></div>
            <span className="text-2xs font-black text-gray-400 uppercase tracking-extra-wide">
          ...
          <div className="flex items-center gap-4 w-full md:w-auto">
            <Button
              ...
              className="flex-1 md:flex-none rounded-xl font-black text-2xs uppercase tracking-widest text-gray-400 h-14 px-8"
            >
              Abort Protocol
            </Button>
            <Button
              ...
              className="flex-1 md:flex-none bg-indigo-600 hover:bg-indigo-700 text-white rounded-2xl px-12 h-14 shadow-xl shadow-indigo-600/20 font-black text-xs uppercase tracking-extra-wide transform active:scale-95 transition-all"
            >
