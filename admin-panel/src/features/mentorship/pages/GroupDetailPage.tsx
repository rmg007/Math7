    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <Tabs defaultValue="overview" className="space-y-6">
        <TabsList className="bg-white/50 backdrop-blur-xl p-1.5 rounded-[1.5rem] border border-white/20 shadow-sm inline-flex">
          ...
          <TabsTrigger
            value="settings"
            className="rounded-xl px-6 py-2.5 data-[state=active]:bg-indigo-600 data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:shadow-indigo-500/20 font-black text-[10px] uppercase tracking-[0.2em] transition-all"
          >
                ...
                <Table className="border-collapse">
                  <TableHeader>
                    <TableRow className="bg-gray-50/50 hover:bg-gray-50/50 border-b-2 border-gray-100">
                      <TableHead className="w-[200px] font-bold text-[10px] uppercase tracking-widest text-gray-400 pl-6 h-12">
                        Student
                      </TableHead>
                      {assignmentSkillIds.map((skillId: string) => (
                        <TableHead
                          key={skillId}
                          className="text-center min-w-[140px] font-bold text-[10px] uppercase tracking-widest text-gray-400 h-12"
                        >
