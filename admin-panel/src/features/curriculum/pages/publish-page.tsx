  ...
  return (
    <div className="max-w-7xl mx-auto space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700 p-4 md:p-8">
              ...
              <div className="flex items-center gap-2">
                ...
                <p className="text-xs font-bold text-gray-500">
                  ...
                  <span className="text-gray-900 font-black">
                    {formatDate(preview?.meta.last_published_at || null)}
                  </span>
                </p>
              </div>
            </div>
          ...
          <div>
            ...
            <p className="text-sm font-bold text-red-700/80 leading-relaxed uppercase tracking-tight">
              {(previewError as Error)?.message ||
                'Check your connection or administrative authority'}
            </p>
          </div>
        </div>
      )}
        ...
        <div className="p-10 space-y-8">
          <div className="bg-indigo-50/50 border border-indigo-100/50 p-6 rounded-[2rem]">
            <p className="text-gray-600 font-medium leading-relaxed tracking-tight">
              Executing this trigger will synchronize all{' '}
              <span className="text-emerald-600 font-black italic">"Live"</span> entities for{' '}
          ...
          {success && (
            <div className="bg-emerald-500/10 border border-emerald-500/20 text-emerald-900 p-6 rounded-[2rem] flex items-center gap-6 animate-in zoom-in-95 duration-500 shadow-lg shadow-emerald-500/5">
              ...
              <div>
                ...
                <p className="text-sm font-bold text-emerald-700/80 uppercase tracking-widest">
                  Protocol v{publishedVersion} is now globally active.
                </p>
              </div>
            </div>
          )}
          ...
          {error && (
            <div className="bg-red-500/10 border border-red-500/20 text-red-900 p-6 rounded-[2rem] flex items-center gap-6 animate-in shake duration-500 shadow-lg shadow-red-500/5">
              ...
              <div>
                ...
                <p className="text-sm font-bold text-red-700/80 uppercase tracking-widest">
                  {error}
                </p>
              </div>
            </div>
      ...
      <AlertDialog open={showConfirmDialog} onOpenChange={setShowConfirmDialog}>
        <AlertDialogContent className="rounded-[2.5rem] border-none bg-white/90 backdrop-blur-2xl p-10 shadow-2xl max-w-2xl">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-gray-500 font-medium">
              ...
              . This action will make content immediately available to students and cannot be
              undone.
            </AlertDialogDescription>
          </AlertDialogHeader>

          <div className="bg-indigo-50/50 border border-indigo-100/50 p-6 rounded-[2rem] mt-6">
          ...
          <AlertDialogFooter className="mt-8 gap-3">
            ...
            >
              {publishMutation.isPending ? (
                <>
                  <div className="h-4 w-4 animate-spin rounded-full border-[2px] border-white border-r-transparent mr-2"></div>
                  Deploying...
                </>
              ) : (
