        ...
        actions={
          <div className="flex items-center gap-2">
            ...
            <Link to={`/questions/new`}>
              <Button className="h-10 px-4 rounded-xl bg-teal-600 hover:bg-teal-700 text-white font-black text-[10px] uppercase tracking-widest gap-1 shadow-md transition-all active:scale-[0.98]">
