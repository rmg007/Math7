          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-gray-50/50 hover:bg-gray-50/50 border-b-2 border-gray-100/50">
                <TableHead className="text-left px-8 py-5 text-[10px] font-black text-gray-400 uppercase tracking-widest h-14">Operator Identity</TableHead>
                ...
                <TableRow>
                  <TableCell colSpan={5} className="px-8 py-24 text-center">
                    <div className="flex flex-col items-center gap-4">
                      <div className="w-16 h-16 bg-gray-50 rounded-3xl border border-gray-100 flex items-center justify-center text-gray-300">
                        <UserX className="w-8 h-8" />
                      </div>
                      <div className="space-y-1">
                        <h4 className="text-lg font-bold text-gray-900 tracking-tight">Zero Operators Detected</h4>
                        <p className="text-sm text-gray-500 font-medium">Reset search parameters to clear directory.</p>
                      </div>
                    </div>
                  </TableCell>
                </TableRow>
