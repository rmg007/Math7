...
test.describe('AI Generation Flow', () => {
          ...
          questions: [
            {
              ...
              difficulty: "easy",
              metadata: {
                options: ["Process of making food", "Process of breathing", "Process of sleep", "Process of growth"],
  ...
  test('should allow uploading a document and generating questions', async ({ page }) => {
    ...
    // Mock file upload
    const fileContent = 'This is a test educational document about photosynthesis. Photosynthesis is the process used by plants to convert light energy into chemical energy.';
