...
test.describe('UI Visual Stability — Rich Text Editor & Symbol Matrix', () => {
  ...
  test.beforeEach(async ({ page }) => {
    ...
    const smBtn = page.locator('div:has-text("Assessment Matrix")').locator('button[title*="Insert Math"]').first();
