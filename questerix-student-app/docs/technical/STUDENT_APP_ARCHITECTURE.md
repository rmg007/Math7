...
app_scope: questerix-student-app
...
│   └── questerix_domain/     # Domain Logic (Consolidated)
├── scripts/                 # Standalone automation
├── supabase/                # Database migrations
├── docs/                    # Technical documentation
├── .agent/                  # Knowledge base (Workflows/Skills)
├── AGENTS.md                # Mobile Engineer persona
├── master-config.json       # Environment definitions
