# 🤖 Qodo AI Master Reference Guide for Questerix

> **Purpose**: This comprehensive guide defines ALL project conventions, patterns, prompts, bug patterns, and checklists for Qodo AI to follow when generating code, tests, and reviews for the Questerix platform.
>
> **How to Use**: Reference this file in your Qodo prompts: `"Follow the conventions in QODO_GUIDE.md"`
...
2. [Flutter/Dart Test Generation](#-flutterdart-test-generation)
3. [TypeScript/React Test Generation](#-typescriptreact-test-generation)
4. [Playwright E2E Test Generation](#-playwright-e2e-test-generation)
5. [Python Test Generation](#-python-test-generation)
6. [Code Review Prompts](#-code-review-prompts)
7. [Bug Pattern Library](#-bug-pattern-library-learned-from-production)
8. [Security Checklist](#-security-checklist)
9. [Database & Migration Safety](#-database--migration-safety)
10. [Questerix-Specific Patterns](#-questerix-specific-patterns)
11. [PR Review Automation](#-pr-review-automation)
12. [Documentation Generation](#-documentation-generation)
13. [Refactoring Assistance](#-refactoring-assistance)
