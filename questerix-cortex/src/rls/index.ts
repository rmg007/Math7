...
export class RlsAuditor {
  ...
  async audit(): Promise<RlsAuditResult> {
    ...
    const msg =
      ...
      "Supabase CLI unavailable, DATABASE_URL not set, and project not linked.";
    ...
    for (const line of lines) {
      ...
      switch (verdictKey) {
        case "REAL_GAP":
          severity = "critical";
          criticalCount++;
          verdictLabel = "🔴 REAL GAP — fix required";
          break;
        case "UNKNOWN":
          severity = "warning";
          unknownCount++;
          verdictLabel = "🟡 Unknown — investigate";
          break;
        default:
          verdictLabel = "🔵 Intentional";
          break;
      }
