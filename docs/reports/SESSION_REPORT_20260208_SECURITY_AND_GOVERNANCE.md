...
### Incident
- **Event**: A Google Cloud API Key (`AIzaSyCVSxXazljPM8MfkrUBqRaoXkZgNB7SNe8`) was found in a backup file (`.secrets.backup.20260207-211705`) which was flagged by Google's secret scanning.
